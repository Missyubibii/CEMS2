                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul
                        ...
                        @if (Auth::user()->role === 'Admin')
                            <li><a href="#" class="mr-4 hover:underline md:mr-6">Admin Settings</a></li>
                        @elseif(Auth::user()->role === 'Giáo viên')
                            <li><a href="#" class="mr-4 hover:underline md:mr-6">Teacher Resources</a></li>
                        @endif
                    </ul>
                </div>
