<ul class="pt-auto mt-auto mb-auto space-y-2 font-medium border-gray-200 dark:border-gray-700">
    <h6 class="text-lg font-bold border-b dark:text-white">Quản lý</h6>
    <li>
        ...
        <x-dropdown
            ...
            <x-slot name="trigger">
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Phòng học</span>
                </button>
            </x-slot>
    ...
    <li>
        <a href="{{ url('/admin/devices') }}"
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Thiết bị</span>
        </a>
    </li>
    ...
    <li>
        <a href="{{ url('/room-bookings/timetable') }}"
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Lịch đặt phòng - thiết bị</span>
        </a>
    </li>

    <li>
        <a href="{{ url('admin/room-bookings') }}"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <svg class="w-[30px] h-[30px] text-gray-800 dark:text-white" aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                viewBox="0 0 24 24">
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Đặt phòng - thiết bị học</span>
        </a>
    </li>
        ...
        <x-dropdown
            ...
            <x-slot name="trigger">
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Đặt phòng học</span>
            ...
            <x-slot name="content">
                <ul class="py-2 space-y-2">
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-5 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Đặt phòng học</a>
                    </li>
                    <li>
                        <a href="#"
