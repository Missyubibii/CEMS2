        ...
        <div class="overflow-x-auto rounded-lg ">
            ...
            <div class="flex flex-col md:flex-row items-center justify-end space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0"
                    ...
                    <button id="add_buildings_button" data-modal-target="add_buildings" data-modal-toggle="add_buildings" type="button"
                            ...
                            @foreach($buildings as $building)
                                <tr>
                                    <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                        <span class="font-semibold">{{ $building->id }}</span>
                                    </td>
                                    <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <button
                                            ...
                                            onclick="document.getElementById('delete-{{ $building->id }}').submit();">
                                            <svg class="w-3.5 h-3.5 mr-2 text-gray-300 dark:text-white"
                                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" fill="currentColor" viewBox="0 0 24 24">
                                                <path fill-rule="evenodd"
                                        ...
                                        <form id="delete-{{ $building->id }}" method="POST"
                                            action="{{ route('admin.buildings.destroy', $building) }}" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                <div>
                                    <label for="building_name"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên tòa học</label>
